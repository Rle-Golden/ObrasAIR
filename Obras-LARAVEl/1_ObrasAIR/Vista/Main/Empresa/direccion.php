...
<head>
    ...
    <title>Oferta Laboral - Direccion</title>
    ...
    <section class="info">
            <div class="form">
                <form action="" method="post">
                    <label for="">Tipo de la via</label> <br>
                    <input required type="text" placeholder="Carrera, kilometro etc"> <br>

                    <label for="">Numero de la via</label> <br>
                    <input required type="number"> <br>

                    <label for="">Letra de la  via</label> <br>
                    <input required type="text"> <br>

                    <label for="">Numero del Cruce</label> <br>
                    <input required type="number"> <br>
