    ...
    <section class="info">
            ...
            <div class="form">
                <form action="" method="post">
                    <label for="">Nombre de la oferta laboral</label> <br>
                    <input required type="text"> <br>

                    <label for="">Descripcion de la oferta laboral</label> <br>
                    <input required type="text"> <br>

                    <label for="">Requisitos para la oferta laboral</label> <br>
                    <input required type="text"> <br>

                    <label for="">Intesidad horaria</label> <br>
                    <input type="number"> <br>

                    <label for="">Salario para la oferta laboral</label> <br>
                    <input type="number"> <br>
